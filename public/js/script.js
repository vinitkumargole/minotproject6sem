...
function goFurther(){
  if (document.getElementById("chkAgree").checked == true) {
    document.getElementById('btnSubmit').style = 'background: linear-gradient(to right, #9747fa, #5737fa);';
  }
  else{
...
function display(n) {
  ...
  s1.style = 'background: #5737fa; color: #FFF;';
  s2.style = 'background: #5737fa; color: #FFF;';
  s3.style = 'background: #5737fa; color: #FFF;';
  s4.style = 'background: #5737fa; color: #FFF;';

  if(n==1) {
    img1.style = 'display: block;';
    s1.style = 'background: #E5E8EF; color: #5737fa;';
  }
  if(n==2) {
    img2.style = 'display: block;';
    s2.style = 'background: #E5E8EF; color: #5737fa;';
  }
  if(n==3) {
    img3.style = 'display: block;';
    s3.style = 'background: #E5E8EF; color: #5737fa;';
  }
  if(n==4) {
    img4.style = 'display: block;';
    s4.style = 'background: #E5E8EF; color: #5737fa;';
  } 
}
